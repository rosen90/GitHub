...
#include <map>
using namespace std;
/////////Задачата работи като цяло, има малък проблем - ако се случи, така че стъпката да стане по-голяма от 9,
/////////ще отпечта някакъв друг char според кода му, а няма да отпечата 10, 11 и тн.
int main() {
