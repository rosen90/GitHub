...
public:
   ...
   void List< NODETYPE >::insertList( const List< NODETYPE > getNewNodeList);
   bool isEmpty() const;
   void print() const;
    ...
    void setFirstPtr(ListNode<NODETYPE> *firstPtr)
    {
        this->firstPtr = firstPtr;
    }

    void setLastPtr(ListNode<NODETYPE> *lastPtr)
    {
        this->lastPtr = lastPtr;
    }
...
void List< NODETYPE >::insertList( const List< NODETYPE > getNewNodeList)
{
   ListNode< NODETYPE > *newPtr = getNewNodeList.getFirstPtr(); // new node
