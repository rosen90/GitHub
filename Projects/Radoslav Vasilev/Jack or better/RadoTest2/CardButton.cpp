...
CardButton::CardButton(SDL_Texture *card_image, SDL_Texture *held_image, SDL_Rect destination, Application *app, Mix_Chunk *sound):WidgetButtonBase(card_image, card_image, destination),
    app(app),
