...
SoundButton::SoundButton(SDL_Texture *default_image, SDL_Texture *mouse_over_image, SDL_Texture *clicked_image, SDL_Rect destination,Mix_Chunk* sound_effect_select):
