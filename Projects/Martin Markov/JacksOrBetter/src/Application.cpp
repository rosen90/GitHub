...
bool Application::InitScene()
{
   ...
   rect.w = 180;
   rect.h = 106;
    IWidget* button = new ButtonDeal(deal,draw,draw,rect,this);
...
bool Application::InitDisplayButtons()
{
    SDL_Rect rect;
    rect.h=768;
    rect.w=1024;
