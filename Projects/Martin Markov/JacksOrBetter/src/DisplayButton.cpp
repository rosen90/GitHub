...
void DisplayButton::Draw(SDL_Renderer *renderer)
{
    ...
    destination_text.x=145;
//    destination_text.y=330;
   ...
   // }
    ...
    //SDL_RenderCopyEx ( renderer,image_profit,NULL,&destination_profit,0,NULL,SDL_FLIP_NONE );
}
