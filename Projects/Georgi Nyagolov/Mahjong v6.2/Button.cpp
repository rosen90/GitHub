...
void Button::renderButton(SDL_Renderer* renderer) {
	...
	render(renderer, getPositionX(), getPositionY(), &stretchRect);
}
...
bool Button::loadMotionFromFile(SDL_Renderer* renderer, std::string path) {
...
bool Button::loadDownFromFile(SDL_Renderer* renderer, std::string path) {
	//Get rid of preexisting texture
	freeDown();
...
bool Button::loadUpFromFile(SDL_Renderer* renderer, std::string path) {
	//Get rid of preexisting texture
	freeUp();
...
bool Button::loadBaseFromFile(SDL_Renderer* renderer, std::string path) {
	//Get rid of preexisting texture
	freeBase();
