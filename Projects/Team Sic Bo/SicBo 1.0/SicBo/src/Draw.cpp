...
bool Draw::loadMediaImages()
{
	...
	backToMenu = loadSurface("resources//images//other//backToMenu.png");
	statsButton = loadSurface("resources//images//help/statistic.png");
		//six dices images
	rollDiceOne = loadSurface("resources//images//six dices//one3d2.png");
	rollDiceTwo = loadSurface("resources//images//six dices//two3d2.png");
	rollDiceThree = loadSurface("resources//images//six dices//three3d2.png");
	rollDiceFour = loadSurface("resources//images//six dices//four3d2.png");
	rollDiceFive = loadSurface("resources//images//six dices//five3d2.png");
	rollDiceSix = loadSurface("resources//images//six dices//six3d2.png");
...
//	//credit info image
	...
	//start menu buttons
		startContinue = loadSurface("resources//images//start//continue.png");
		startNewGame = loadSurface("resources//images//start//newGame.png");
		startQuickGuide = loadSurface("resources//images//start//quickGuide.png");
		startCred = loadSurface("resources//images//start//cred.png");
		startQuit = loadSurface("resources//images//start//quit.png");
...
//Each Dice image
	...
	menuFiller(10, 450, 70, startContinue, surface);
	menuFiller(11, 450, 160, startNewGame, surface);
	menuFiller(12, 450, 250, startQuickGuide, surface);
	menuFiller(13, 450, 340, startCred, surface);
	menuFiller(14, 450, 430, startQuit, surface);
	menuFiller(15, 856, 650, backToMenu, surface);
}
