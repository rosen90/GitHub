...
bool Application::Init()
{
    ...
    main_window = SDL_CreateWindow ( "Application", SDL_WINDOWPOS_CENTERED,
                                     SDL_WINDOWPOS_CENTERED,1024, 768, SDL_WINDOWEVENT_SHOWN);
    if ( !main_window )
    {
        return false;
    }
...
bool Application::InitResources()
{
    ...
    table= LoadTexture("images/background.png");
